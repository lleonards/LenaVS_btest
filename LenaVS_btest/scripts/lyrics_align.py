...
def main():
    ...
    parser.add_argument("--window", type=float, default=float(os.environ.get("LYRICS_ALIGN_WINDOW_SECONDS", "30")))
    parser.add_argument("--context", type=float, default=float(os.environ.get("LYRICS_ALIGN_CONTEXT_SECONDS", "2")))
    parser.add_argument(
        "--model-dir",
