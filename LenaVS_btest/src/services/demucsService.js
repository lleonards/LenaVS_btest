...
const BUNDLED_PYTHON_BIN = path.join(PROJECT_ROOT, '.runtime', 'python312', 'bin', 'python3.12');
const BUNDLED_DEMUCS_CLI_BIN = path.join(PROJECT_ROOT, '.runtime', 'python312', 'bin', 'demucs');
const DEMUCS_PYTHON_BIN = process.env.DEMUCS_PYTHON_BIN
  || (existsSync(BUNDLED_PYTHON_BIN) ? BUNDLED_PYTHON_BIN : 'python3');
const DEMUCS_CLI_BIN = process.env.DEMUCS_CLI_BIN
  || (existsSync(BUNDLED_DEMUCS_CLI_BIN) ? BUNDLED_DEMUCS_CLI_BIN : 'demucs');
