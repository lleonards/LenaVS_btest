...
const PYTHON_BIN = process.env.LYRICS_ALIGN_PYTHON_BIN || 'python3';
...
const MODE = String(process.env.LYRICS_ALIGN_MODE || 'align').trim().toLowerCase();
...
const WINDOW_SECONDS = String(process.env.LYRICS_ALIGN_WINDOW_SECONDS || '30');
const CONTEXT_SECONDS = String(process.env.LYRICS_ALIGN_CONTEXT_SECONDS || '2');
...
export const getAlignerQueueInfo = () => ({ pending: pendingJobs });
