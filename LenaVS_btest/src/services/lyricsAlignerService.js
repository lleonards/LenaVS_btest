...
const ALIGNER_PYTHON_BIN = process.env.LYRICS_ALIGNER_PYTHON || 'python3';
 ...
 *
 * CLI usada:
 *   ctc-forced-aligner --audio_path <wav> --text_path <txt> --language <iso639-3> \
 *     --split_size word --device cpu
 */
...
export const alignLyricsWordsWithAudio = async (audioUrl, lyricsText, opts = {}) => {
  ...
  try {
    ...
    console.log(`[lyricsAligner] ✅ ${alignedWords.length} palavras com timestamps.`);
