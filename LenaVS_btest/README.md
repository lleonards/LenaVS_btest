...
`POST /api/lyrics/sync` (autenticado)
...
// Success 200
{ "success": true, "timings": [{ "start": "00:10", "end": "00:12" }, ...], "words": 6 }

// Failure 422/503 — nenhum tempo é alterado
{ "code": "LYRICS_SYNC_FAILED", "error": "Não foi possível sincronizar a letra..." }
```
