...
# Separe múltiplas origens por vírgula. Inclua a URL exata do frontend
# publicado e mantenha localhost apenas se também for testar localmente.
ALLOWED_ORIGINS=https://seu-frontend.onrender.com,http://localhost:5173,http://127.0.0.1:5173
...
- Depois de alterar estas URLs, faça um novo deploy do backend. A URL do
  frontend (`https://lenavs-ftest.onrender.com`, por exemplo) precisa estar
  na lista do backend correspondente.
